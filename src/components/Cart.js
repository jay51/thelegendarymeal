              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <div className="add-remove">
                    ...
                    <button className="btn btn-dark" onClick={()=>{this.handleSubtractQuantity(item.id)}}>SUB</button>
                  </div>
                  <button className="btn btn-danger mt-2" onClick={()=>{this.handleRemove(item.id)}}>Remove</button>
                  <p className="card-text"><small className="text-muted">Made fresh within few hours from your ordere!</small></p>
                </div>
              </div>
            </div>
          </div>
